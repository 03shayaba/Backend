...
const EmailVerify = () => {
  const { backendUrl , setIsLoggedin , isLoggedin , getUserData, userData}  = useContext(AppContext);
  ...
  const onSubmitHandler =async(e) =>{
    try {
      ...
      const otp = otpArray.join('')
       const {data} = await axios.post(backendUrl+ '/api/auth/verufy-account',{otp})
